...
namespace iNFeDll.RegraDeNegocios
{
    public class SchemaXML
    {
        ...
        /// </summary>
        /// <by>Rafael Almeida - Integra Solutions</by>
        public static void CriarListaIDXML()
        {
            ...
            lstXMLTag.Add("consDPEC"); 
            lstXMLID.Add(9);
            lstXMLTextoID.Add("XML de consulta do DPEC no SCE (Sistema de Contingência Eletrônica)");   
            lstXMLSchema.Add("consDPEC_v1.01.xsd");
            lstXMLTagAssinar.Add(string.Empty);
            #endregion
